...
public class IntData {
    ...
    public static HashMap<String, Integer> getRomanToArabicMap() { // метод, находящий по поступившему римскому значению ключ этого значения и возвращающий арабское значение из карты romanToArabicMap
        return romanToArabicMap;
    }

    public static HashMap<Integer, String> getArabicToRomanMap() { // метод, находящий
    ...
    public static ArrayList<String> getRome() { //гетер, возвращающий список rome
        return rome;
    }
}
